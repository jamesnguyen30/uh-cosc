...
static pthread_mutex_t mutext_child_wait_grandchild[100];
...
void * grandchild_print_message(void * arg_void_ptr){
	...
	if(*is_network_available == false){
		...
		*is_network_available = true;
		...
		pthread_mutex_unlock(&mutex_child_wait_grandchild[child_thread_num]);
	}
...
void * print_message(void * arg_void_ptr){
	...
	pthread_cond_wait(&cond_grandchild[order], 
